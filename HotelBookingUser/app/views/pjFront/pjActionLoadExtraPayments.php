...
<div style="max-width: 1060px; ">
	<div id="pjWrapperExtraPayments_<?php echo $cid;?>">
		<div id="pjExtraPaymentsContainer_<?php echo $cid; ?>" class="container-fluid"></div>
	</div>
</div>
<script type="text/javascript">
var pjQ = pjQ || {},
	ExtraPayments_<?php echo $cid; ?>;
(function () {
	"use strict";
			...
			loadScript("<?php echo PJ_INSTALL_URL . PJ_LIBS_PATH; ?>pjQ/pjQuery.validate.min.js", function () {
				loadScript("<?php echo PJ_INSTALL_URL . PJ_LIBS_PATH; ?>pjQ/bootstrap/js/bootstrap.min.js", function () {
					loadScript("<?php echo PJ_INSTALL_URL . PJ_LIBS_PATH; ?>pjQ/pjQuery.ba-hashchange.min.js", function () {
						loadScript("<?php echo PJ_INSTALL_URL . PJ_JS_PATH; ?>pjExtraPayments.js", function () {
							ExtraPayments_<?php echo $cid; ?> = new ExtraPayments(options);
						});
					});
				});
			});
