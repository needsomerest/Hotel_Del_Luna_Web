		...
		<tr class="tab-price-item">
			...
			<td>
				<div class="text-right">
					<a href="javascript:void(0);" class="btn btn-primary btn-outline btn-sm m-l-xs lnkCopyRow"><i class="fa fa-copy"></i></a>
				</div>
			</td>
			<td>
				<div class="text-right">
					<a href="javascript:void(0);" class="btn btn-danger btn-outline btn-sm m-l-xs lnkRemoveRow"><i class="fa fa-trash"></i></a>
				</div>
			</td>
		</tr>
	</tbody>
