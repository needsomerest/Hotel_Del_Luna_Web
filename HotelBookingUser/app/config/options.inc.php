...
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "4.0.1");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjBase', 'pjAuth', 'pjInstaller', 'pjGallery', 'pjPayments', 'pjPaypal', 'pjAuthorize', 'pj2checkout', 'pjBraintree', 'pjMollie', 'pjPaypalExpress', 'pjSkrill', 'pjStripe', 'pjExtraPayments');
...
$CONFIG['permission_items_order'] = array(
    'pjAdmin_pjActionIndex',
    'pjAdminAvailability_pjActionIndex',
    'pjAdminBookings',
    'pjAdminClients',
    'pjAdminRooms',
    'pjAdminDiscounts',
