<?php
$config = array();
$config['PLUGIN_NAME'] = 'pjBase';
$config['PLUGIN_MODEL'] = 'pjBaseAppModel';
...
$config['PLUGIN_BACKUP_DB_CHUNK'] = 512;

$config['PLUGIN_ID'] = "107";
$config['PLUGIN_VERSION'] = "2.0";
$config['PLUGIN_BUILD'] = "2.0.7";
...
$plugins[$config['PLUGIN_NAME']] = array();
