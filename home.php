...
<head>
    ...
    .banner_area .bg-parallax {
        background: url("bed.jpg") no-repeat scroll center 0/cover;
        opacity: 0.70;
    }
    </style>
</head>
                ...
                <ul class="navbar-nav ms-auto text-center">
                    <li class="nav-item active">
                        <a class="nav-link" href="home.php"
                            style="margin-right: 20px;font-weight: bold; color:  #B897F3 !important;">OUR HOTELS</a>
                    </li>
                    <li class="nav-item active">
                    ...
                    <form action="bookthebook.php" method="post">
                        <div class="row row-cols-auto">
                            ...
                            <div class="col">
                                ...
                                <div class="book_tabel_item">
                                    <div class="form-group">
                                        <select class="form-control" name="nroom" required>
                                            <option>0</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                            ...
                            <div class="col">
                                ...
                                <div class="book_tabel_item">
                                    <div class="form-group">
                                        <select class="form-control" name="nadult" required>
                                            <option>0</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                            ...
                            <div class="col">
                                ...
                                <div class="book_tabel_item">
                                    <div class="form-group">
                                        <select class="form-control" name="nchild" required>
                                            <option>0</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
...
<div class="card-group">
    <div class="card">
      <img class="card-img-top" src="bk.png" alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title">BANGKOK</h5>
        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, nam?</p>
      </div>
    </div>
    <div class="card">
      <img class="card-img-top" src="cm.png" alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title">CHIANG-MAI</h5>
        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit, ab?</p>
      </div>
    </div>
    <div class="card">
      <img class="card-img-top" src="pt.png" alt="Card image cap">
      <div class="card-body">
        <h5 class="card-title">PATTAYA</h5>
        <p class="card-text">Lorem ipsum adipisicing elit. Eaque laudantium officia quos impedit!</p>
      </div>
    </div>
    <div class="card">
        <img class="card-img-top" src="hh.png" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">HUAHIN</h5>
          <p class="card-text">Lorem ipsum dolor sit amet consect adisicing elit. Expedita, iusto.</p>
        </div>
      </div>
      <div class="card">
        <img class="card-img-top" src="pk.png" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">PHUKET</h5>
          <p class="card-text">Lorem ipsum sit, amet adipisicing elit. Dolorum, minima ipsam?</p>
        </div>
      </div>
  </div> -->
